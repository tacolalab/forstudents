...
public class file_verb {//start pgm
    ...
    public StringBuffer verbgeneration(String filein, String ruleselected) {//start function
        byte[] a = {1};
        ...
        String[] str1 = {"வினைச்சொல் விதிகள்", "வினை+காலம்+பால்/இட/எண்", "வினை+காலம்+துனை1+பால்/இட/எண்",
            ...
            "வினை+உம்+பெயரெச்ச பின்னொட்டு", "வினை+இறந்தகாலம்+நிபந்தனை விகுதி", "வினை+எச்சம்+ஈற்றசை", "வினை+எச்சம்+நிலை+(பால்/இட/எண்)/(தொ.பெ.விகுதி)/(+வே.உ)", "ஏ.மு.ஒ.விகுதி(ISM) / ஏ.மு.ப.விகுதி(IPM)",
