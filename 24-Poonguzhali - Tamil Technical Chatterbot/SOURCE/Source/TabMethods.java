/**
  ...
  *  one is to convert the string into the internal code
  *  second is to revert the internal code to string
  */
import java.io.*;
import java.util.*;
...
/**
  *  This to revert the byte array into the string
  */
...
/**
  *  This to convert the string into byte array
  */
  ...
  // this 34 is wrong actualy it has to be 171 due to the mistake of alscrypt
